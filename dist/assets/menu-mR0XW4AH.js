import{s as g,c as l,o as h,e as c,g as r,r as a,d,h as p,u as f,a as w}from"./firebase-init-BZinYjX3.js";window.innerWidth>900&&window.location.replace("dashboard.html");const v=document.getElementById("mobile-admin-panel"),y=document.getElementById("menu-logout-btn"),b=document.getElementById("close-menu-btn");b.addEventListener("click",()=>{window.history.back()});y.addEventListener("click",()=>{g(l).then(()=>window.location.href="index.html")});h(l,async t=>{if(t){c();try{const o=await r(a(d,"roles/"+t.uid));o.exists()&&o.val()==="admin"&&x(t.uid)}catch(o){console.error(o)}finally{p()}}else window.location.href="index.html"});async function x(t){v.classList.remove("hidden"),((e,n)=>{const i=document.getElementById(e);i.checked=localStorage.getItem(n)!=="false",i.addEventListener("change",m=>localStorage.setItem(n,m.target.checked))})("mob-singularity","pref_show_singularity");const s=(await r(a(d,`users/${t}/equipped`))).val()||{};if(s.title==="accountant"){const e=s.title_override||"",n=document.getElementById("mob-accountant-wrapper");n.innerHTML=`
